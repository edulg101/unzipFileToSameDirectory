...
public class App {
    ...
    public static void unzip(String zipFilePath, String destDirectory) throws IOException {
        ...
        while (entry != null) {
            ...
            String completeFilePath = destDirectory + File.separator + entry.getName();
            File f = new File(entry.getName());
            String parent = f.getParentFile().getName();
            int parentSize = parent.length();
            int index = completeFilePath.indexOf(File.separator + File.separator);
            String filePath = completeFilePath.substring(0, index) + completeFilePath.substring(index + parentSize + 2);
